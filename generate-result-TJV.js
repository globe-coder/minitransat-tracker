...
const inputJson = fs.readFileSync('boats-TJV.json', 'utf8');
const inputTracks = fs.readFileSync('tracks-TJV.json', 'utf8');
...
fs.writeFileSync('boats_result_TJV.json', resultJson, 'utf8');
